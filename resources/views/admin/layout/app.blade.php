...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>MIMAX SOFTWARE GROUP</title>
							...
							<a class="nav-link user-profile" href="javascript:void(0);"  role="button" data-bs-toggle="dropdown">
								<div class="header-info2 d-flex align-items-center">
									...
									<div class="d-flex align-items-center sidebar-info">
										<div class="user-info">
											<span class="font-w500 d-block  fs-5 text-white">O`ktam Yakubov</span>
		...
		<div class="dlabnav">
			<div class="dlabnav-scroll">
				...
				<ul class="metismenu" id="menu">
					<li><a class="has-arrow " href="{{route('app')}}" aria-expanded="false">
						<div class="menu-icon">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
						<div class="menu-icon">
							...
							<span class="nav-text">Expert Team</span>
						</a>
						<ul aria-expanded="false">
							<li><a href="{{route('team-member-index')}}">Team member</a></li>
						</ul>
					</li>
